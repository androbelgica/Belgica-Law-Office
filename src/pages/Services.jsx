...
export default function Services() {
    // Mock services data
    const services = [
        { slug: 'notarial-services', title: 'Notarial Services', description: 'Comprehensive notarial services for all legal documents.', icon: 'DocumentTextIcon' },
        { slug: 'legal-consultation', title: 'Legal Consultation', description: 'Expert advice for individuals and businesses.', icon: 'UserGroupIcon' },
        { slug: 'litigation', title: 'Litigation', description: 'Representation in civil and criminal cases.', icon: 'ScaleIcon' },
        { slug: 'corporate-law', title: 'Corporate Law', description: 'Business registration, detailed compliance, and contracts.', icon: 'BuildingOfficeIcon' },
        { slug: 'real-estate', title: 'Real Estate', description: 'Property transactions and land disputes.', icon: 'HomeIcon' },
        { slug: 'family-law', title: 'Family Law', description: 'Marriage, annulment, and support cases.', icon: 'HeartIcon' },
    ];
