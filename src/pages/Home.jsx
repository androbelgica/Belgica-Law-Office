...
export default function Home() {
    ...
    const services = [
        { id: 1, slug: 'notarial-services', title: 'Notarial Services', description: 'Affidavits, Deeds, and other legal documents.', icon: 'DocumentTextIcon' },
        { id: 2, slug: 'legal-consultation', title: 'Legal Consultation', description: 'Expert legal advice for your concerns.', icon: 'UserGroupIcon' },
        { id: 3, slug: 'litigation', title: 'Litigation', description: 'Representation in court cases.', icon: 'ScaleIcon' },
        { id: 4, slug: 'corporate-law', title: 'Corporate Law', description: 'Legal support for businesses.', icon: 'ShieldCheckIcon' },
        { id: 5, slug: 'real-estate', title: 'Real Estate', description: 'Property transactions and land disputes.', icon: 'HomeIcon' },
        { id: 6, slug: 'family-law', title: 'Family Law', description: 'Marriage, annulment, and support.', icon: 'HeartIcon' },
    ];
    ...
    const testimonials = [
        { id: 1, name: 'Maria Santos', content: 'Atty. Belgica provided excellent legal advice regarding my property case. Highly recommended!', role: 'real estate client', rating: 5 },
        { id: 2, name: 'John Doe', content: 'Very professional and responsive. Solved our corporate dispute efficiently.', role: 'Business Owner', rating: 5 },
        { id: 3, name: 'Sarah L.', content: 'Compassionate handling of my family law case. I felt supported throughout the process.', role: 'Client', rating: 5 },
    ];
    ...
    return (
        <Layout title="Professional Legal Services in Metro Manila">
            ...
            <ServiceSlider services={servicesWithIcons} />
