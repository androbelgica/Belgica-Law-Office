...
**Purpose**
To provide BelgicaLaw with a secure and user-friendly internal dashboard to manage website content without needing to manually edit code. The CMS will allow the admin to manage text content, service listings, inquiries, FAQ/blog entries, and AI-generated legal documents through the DIY (Draft-It-Yourself) module.
...
- Manage the DIY (Draft-It-Yourself) document drafting system
...
- Content editing modules:
  ...
  - DIY Document Manager (view logs, generated documents, monitor usage)
...
- `/admin/diy-documents` – Manage generated AI documents
...
- `ChatSession` – Logs of DIY chatbot questions/answers
- `GeneratedDocument` – AI-drafted documents with metadata
...
### 4.1 Dashboard
- Welcome message
- Quick stats: # of inquiries, published services, DIY usage count
...
- Monitor and manage DIY (Draft-It-Yourself) document sessions
...
- Monitor DIY module usage and refine AI prompts
