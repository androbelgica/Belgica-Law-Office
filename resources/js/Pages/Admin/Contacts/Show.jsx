...
export default function Show({ auth, contact, flash }) {
    ...
    const getStatusBadge = (status) => {
        const badges = {
            unread: { bg: 'bg-red-100', text: 'text-red-800', icon: EnvelopeIcon },
        ...
        <AdminLayout user={auth.user}>
            ...
            <div className="py-6">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="px-6 py-6">
                            <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <dd className="mt-1 text-sm text-gray-900 font-medium">{contact.subject}</dd>
                                </div>
                                <div>
                                ...
                                {contact.ip_address && (
                                    <div>
                                        ...
                                        <dd className="mt-1 text-sm text-gray-900">{contact.ip_address}</dd>
                                    </div>
                                )}
                            </dl>
                        </div>
                    ...
                    {/* Admin Reply Section */}
                    {contact.status === 'replied' && contact.admin_reply ? (
                        <div className="bg-green-50 shadow rounded-lg overflow-hidden mb-6">
                            <div className="px-6 py-4 border-b border-green-200">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-sm text-green-600">
                                        Sent {new Date(contact.replied_at).toLocaleDateString('en-US', {
                                            year: 'numeric',
                                            month: 'short',
                                            day: 'numeric',
                                            hour: '2-digit',
                            ...
                            <div className="px-6 py-6">
                                <div className="prose max-w-none">
                                    <p className="text-green-800 whitespace-pre-wrap">{contact.admin_reply}</p>
                                </div>
                            </div>
                        </div>
                    ) : (
                            ...
                            {showReplyForm ? (
                                ...
                                <div className="px-6 py-6 text-center text-gray-500">
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">
                                        Click the Reply button above to respond to this contact.
                                    </p>
                                </div>
                            )}
                        </div>
